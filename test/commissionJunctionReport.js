...
const { getCommissionReport } = require('../controllers/CommissionJunctionController');
...
describe("commission report", () => {
    ...
    it('should be a valid report from Commission Junction', (done) => {
        const params = {
            salesReportUrl: 'https://commissions.api.cj.com/query',
            token: '6xr4d00nmkj9j3nsr3wxqrhvpn',
            requestorCid: '7002073'
        }
        getCommissionReport(params).then((result) => {
            console.log(result)
            done();
        });
    })

    // it('should be a valid unify report', (done) => {
    //     const params = {
    //         salesReportUrl: 'https://commissions.api.cj.com/query',
    //         token: '6xr4d00nmkj9j3nsr3wxqrhvpn'
    //     }
